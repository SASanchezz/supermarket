...
namespace supermarket.Models
{
    internal static class Customer
    {
        ...
        public const int cust_surname = 1;
        public const int cust_name = 2;
        public const int cust_patronymic = 3;
        ...
        public static void AddCustomer(string cardNumber, string surname, string name, string patronymic,
            string phoneNumber, string city, string street, string zipcode, double percent)
        {
