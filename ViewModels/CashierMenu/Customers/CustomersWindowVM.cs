using supermarket.Windows.CashierMenu.Customers;
using supermarket.Navigation.WindowViewModels;
using supermarket.ViewModels.CashierMenu.Customers.Changes;
using System;
using System.Windows;
using supermarket.ViewModels.BaseClasses;

namespace supermarket.ViewModels.CashierMenu.Customers
{
    /* 
     * Controls CashierCustomers Window
     * Set navigating Windows as CashierAddCustomer Window, CashierEditCustomer Window
     */
